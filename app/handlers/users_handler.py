...
from app.models.request.users_request import UserCreateRequest, UserFetchFilter
...
async def create_users(
    ...
    response = await builder.build_create_users(requests=requests, created_by = context.user_id)
